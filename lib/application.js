  ...
  return function requestListener (req, res) {
    ...
    thunk = thunks({
      ...
      onstop: function (sig) {
        ...
        seq.call(ctx, ctx.onPreEnd)(respond)
      },
    ...
    res.statusCode = 404
    var runner = middleware.length ? seq.call(ctx, middleware) : thunk.call(ctx)
    if (mainHandle) runner = runner(function () { return mainHandle.call(ctx) })
    runner(function () {
      var hooks = ctx.onPreEnd
      return hooks.length ? seq.call(ctx, hooks) : null
    })(respond)
  }
}
