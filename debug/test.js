...
var v4 = require('./thunks.js')();
var v5 = require('../thunks.js')();
var len = 10000, times = 10000;
var tasks = [];
...
v4(function *(){
  ...
  //
  console.time('co v5 test2');
  for (i = 0; i < times; i++) yield v5(testBody);
  console.timeEnd('co v5 test2');
  //
